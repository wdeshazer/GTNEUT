...
c/                  well as for the constant energy case (i_e0 = 1).
     ...
     .     svcx0, svel0, sveln0, vs0, invmfp0, svion_tot0, albdfit
...
c/    Adjacent cell is a wall segment:  
	...
	if(e_fast.eq.0)then
	            print*, 'e_fast = ',e_fast 
                   print*, 'tneut  = ',tneut(k,j)
                   print*, 'k= ',k,' j= ',j
                   print*, 'refln(kw)= ',refln(kw)
	            print*, 'dsvioniwf =',dsvioniwf
	            print*, 'dsvioniws =',dsvioniws
	            print*, 'dsvioniw0 =',dsvioniw0
	            print*, 'dsvcxwf =',dsvcxwf
	            print*, 'dsvcxws =',dsvcxws
	            print*, 'dsvcxw0 =',dsvcxws
                   print*, '####################'
	endif
                  endif
                  if(i_e0.eq.3)then
...
c/    albdfit : the albedo coefficient
