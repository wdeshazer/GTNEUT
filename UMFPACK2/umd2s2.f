...
C       Cntl:           real control parameters, see UMD2IN
C       Icntl:          integer control parameters, see UMD2IN
...
C
C       X (1..n):       solution
C       Info:           integer informational output, see UMD2IN
C       Rinfo:          real informational output, see UMD2IN
C
