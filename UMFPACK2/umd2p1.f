...
C-----------------------------------------------------------------------
        ...
        IF (WHO .EQ. 1) THEN 
           IF (WHERE .EQ. 1) THEN 
              WRITE (IO, 200) 'UMD2FA input:       '
              PRLU = .FALSE.
           ELSE 
              WRITE (IO, 200) 'UMD2FA output:      '
              PRLU = .TRUE.
           ENDIF 
        ELSE IF (WHO .EQ. 2) THEN 
           IF (WHERE .EQ. 1) THEN 
              WRITE (IO, 200) 'UMD2RF input:       '
              PRLU = .TRUE.
           ELSE 
              WRITE (IO, 200) 'UMD2RF output:      '
              PRLU = .TRUE.
           ENDIF 
        ELSE IF (WHO .EQ. 3) THEN 
           IF (WHERE .EQ. 1) THEN 
              WRITE (IO, 200) 'UMD2SO input:       '
              PRLU = .TRUE.
           ELSE 
              WRITE (IO, 200) 'UMD2SO output:      '
              PRLU = .FALSE.
           ENDIF 
        ENDIF 
...
C-----------------------------------------------------------------------
     ...
     $                    ' INDEX for next call to UMD2RF'
              WRITE (IO, *)
     $  '      INFO (23): ',INFO (23),' : memory needed in',
     $                    ' VALUE for next call to UMD2RF'
           ELSE 
              WRITE (IO, *)
...
C-----------------------------------------------------------------------
        ...
        IF (WHO .EQ. 1) THEN 
           IF (WHERE .EQ. 1) THEN 
              WRITE (IO, 200) 'end of UMD2FA input '
           ELSE 
              WRITE (IO, 200) 'end of UMD2FA output'
           ENDIF 
        ELSE IF (WHO .EQ. 2) THEN 
           IF (WHERE .EQ. 1) THEN 
              WRITE (IO, 200) 'end of UMD2RF input '
           ELSE 
              WRITE (IO, 200) 'end of UMD2RF output'
           ENDIF 
        ELSE IF (WHO .EQ. 3) THEN 
           IF (WHERE .EQ. 1) THEN 
              WRITE (IO, 200) 'end of UMD2SO input '
           ELSE 
              WRITE (IO, 200) 'end of UMD2SO output'
           ENDIF 
        ENDIF 
