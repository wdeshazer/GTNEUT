...
c/                  well as for the constant energy case (i_e0 = 1).
     ...
     .     svcx0, svel0, sveln0, vs0, invmfp0, svion_tot0, albdfit_md
...
c/    albdfit_md : the albedo coefficient
